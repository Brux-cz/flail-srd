...
Používejte tvory k vytváření překážek a hrozeb. Ti, kteří jsou zde uvedeni, slouží především jako inspirace pro tvorbu nových protivníků pro postavy. Pokud tvor uvádí u útoku Jakýkoli zásah, Silný zásah nebo Smrtící úder, tento efekt nastává **navíc** k běžným bojovým důsledkům, pokud není uvedeno jinak. Jakýkoli zásah znamená, že efekt nastává při Drobném zásahu, Silném zásahu i Smrtícím úderu. Protivníci mohou provést jeden útok za kolo, pokud není uvedeno jinak.

## Statistiky protivníků

- **Úroveň:** celková síla tvora. Obzvláště důležitá pro určitá kouzla nebo efekty.
- **bz:** počet bodů životů. Pokud klesne na nulu, tvor je vyřazen ze hry.
- **Hody:** pokud efekt vyžaduje záchranný hod (jakéhokoli druhu kromě Morálky), musí hodit stejně nebo pod uvedenou hodnotu, aby uspěl.
- **Obrana:** odečtěte uvedenou hodnotu od veškerého poškození.
- **Pohyb:** pomalí (P) si musí vybrat mezi pohybem a akcí; rychlí (R) se mohou pohnout dvakrát a provést akci ve stejném kole; běžní (B) jednají podobně jako hráčské postavy.
- **Morálka:** hod na Morálku — musí hodit stejně nebo pod hodnotu.
- **Typ:** typ může být důležitý pro kouzla, magické předměty nebo zvláštní schopnosti.
- **Útoky:** protivníci mohou mít různé útoky. Vypravěč by neměl používat stejný útok dvakrát za sebou.
- **HZ:** počet k6 na hod na zásah.
- **POŠ:** velikost poškození.
- **Speciální:** neobvyklá nebo unikátní vlastnost protivníka.

## Tvorba tvorů

*Použijte jako základ pro tvorbu vlastních tvorů*

| Síla | Úroveň | bz | Hody | Obrana | HZ | POŠ |
|------|--------|-----|------|--------|-----|-----|
| Slabý | 1-3 | 5-15 | 6-8 | 0 | 4-5 | 1-2 |
| Průměrný | 4-6 | 15-25 | 9-12 | 1-2 | 6-7 | 3-4 |
| Silný | 7-9 | 25-35 | 12-15 | 2-3 | 8-9 | 5-6 |
| Božský | 10 | 35-100 | 15-18 | 4 | 10+ | 7+ |

Po stanovení statistik zvažte přidání unikátních vlastností:

- **Různé typy útoků** s proměnlivými hodnotami HZ a POŠ.
- **Více útoků** za kolo, zejména u silnějších tvorů.
- Zajímavý efekt **Silného zásahu**.
- Speciální **Smrtící úder**, který nahrazuje hod na Tabulku smrti.
- **Dodatečné efekty** při sekvenci, páru nebo trojici na úspěšném zásahu.
- Originální **stavy** (Vyděšený, Pokrytý slizem aj.). Použijte prázdné karty stavů.
- Speciální **imunity** (zranitelnost pouze ohněm nebo magií).

### Hardcore mód

Pokud chcete, aby byl FLAIL pro postavy obzvláště smrtící, zvyšte všem tvorům HZ o 1.
...
**HARPYJE** — *Melodie, které nepřináší přátele*

Úroveň 2 | 6 bz | Hody 8 | Obrana 0 | Pohyb B | Morálka 10 | Člověk-pták

- **Zpěv:** HZ 5, POŠ 2. *Smrtící úder: místo zabití převezme kontrolu nad cílem na jedno kolo.*

**KRVAVÝ SUP** — *Přilákaný pachem čerstvé krve*

Úroveň 2 | 8 bz | Hody 6 | Obrana 0 | Pohyb B | Morálka 9 | Pták

- **Sání krve:** HZ 5, POŠ 1. *Silný zásah: přisaje se k cíli a způsobuje 2 poškození za kolo.*

### Průměrní

**GRYFON** — *Zahlédne myš na míli daleko*

Úroveň 6 | 25 bz | Hody 11 | Obrana 1 | Pohyb R | Morálka 12 | Pták

- **Zobák:** HZ 6, POŠ 3.
- **Lví drápy:** HZ 7, POŠ 4. *Jakýkoli zásah: při třech párech způsobí dodatečné poškození k8.*

**FÉNIX** — *Popelářů se bojí víc než predátorů*

Úroveň 5 | 15 bz | Hody 13 | Obrana 0 | Pohyb R | Morálka 11 | Pták

- **Ohnivá křídla:** HZ 7, POŠ 3.
- **Drápy:** HZ 5, POŠ 3.

**Speciální:** pokud je zabit, vzplane a způsobí k10 poškození všem Blízko; za dvě kola se znovu probudí.

**PTERODAKTYL** — *Často loví v koordinovaných smečkách*

Úroveň 4 | 17 bz | Hody 12 | Obrana 1 | Pohyb B | Morálka 12 | Dinosaurus

- **Drápy:** HZ 7, POŠ 3.

### Silní

**KOHOUTICE** — *Všichni z ní zkamení hrůzou*

Úroveň 7 | 20 bz | Hody 12 | Obrana 0 | Pohyb B | Morálka 13 | Pták

- **Zobák:** HZ 8, POŠ 4. *Smrtící úder: místo zabití udělí cíli stav Zkamenělý.*

**ROK** — *Byl spatřen, jak nese slona*

Úroveň 8 | 35 bz | Hody 14 | Obrana 1 | Pohyb R | Morálka 15 | Pták

- **Zobák:** HZ 8, POŠ 4.
- **Drápy:** HZ 9, POŠ 5. *Smrtící úder: místo zabití odnese cíl pryč, aby nakrmil svá mláďata.*

**Speciální:** provede dva útoky za kolo; nejprve zobákem, poté drápy.

## Otravně velký hmyz

### Slabí

**OBŘÍ STONOŽKA** — *Plíží se potichu a kouše s chirurgickou přesností*

Úroveň 2 | 12 bz | Hody 9 | Obrana 1 | Pohyb B | Morálka 8 | Hmyz

- **Kousnutí:** HZ 5, POŠ 2. *Silný zásah: paralyzuje cíl na k4 kol.*

**VELKÝ RUDÝ ŠTÍR** — *Pohybuje se jako motýl, bodá jako včela*

Úroveň 3 | 13 bz | Hody 9 | Obrana 1 | Pohyb B | Morálka 8 | Hmyz

- **Jedovaté žihadlo:** HZ 5, POŠ 2. *Silný zásah: způsobí stav Otrávený.*
- **Klepeta:** HZ 5, POŠ 4.

**ZABIJÁCKÁ VČELA** — *Útočí v rojích, bodají jako jeden*

Úroveň 1 | 6 bz | Hody 6 | Obrana 0 | Pohyb B | Morálka 7 | Hmyz

- **Žihadlo:** HZ 4, POŠ 2.

**ROJ KOBYLEK** — *Sestoupí v mracích a pohltí vše, co mu stojí v cestě*

Úroveň 1 | 7 bz | Hody 8 | Obrana 0 | Pohyb R | Morálka 10 | Hmyz

- **Kousnutí:** HZ = aktuální bz, POŠ 2.

**ROJ OHNIVÝCH MRAVENCŮ** — *Rozpustí tělo za k4 minut*

Úroveň 2 | 7 bz | Hody 8 | Obrana 0 | Pohyb R | Morálka 11 | Hmyz

- **Drápy:** HZ = aktuální bz, POŠ 2. *Smrtící úder: zahubí cíl v žravém šílenství (ignorujte Tabulku smrti).*

### Průměrní

**OBŘÍ PAVOUK** — *Osm noh, osm očí, osm způsobů, jak zemřít*

Úroveň 6 | 16 bz | Hody 12 | Obrana 2 | Pohyb B | Morálka 8 | Hmyz

- **Kousnutí:** HZ 7, POŠ 3. *Smrtící úder: místo zabití obalí cíl hedvábným kokonem.*

**REZAVÁ PŘÍŠERA** — *Zbožňuje heavy metal*

Úroveň 5 | 20 bz | Hody 13 | Obrana 1 | Pohyb B | Morálka 12 | Hmyz

- **Tykadla:** HZ 6, POŠ 2. *Silný zásah: sežere kovový předmět nesený nebo nošený cílem.*

**Speciální:** označte opotřebení na jakémkoli kovovém předmětu, který se dotkne Rezavé příšery.

### Silní

**KOLOSÁLNÍ KUDLANKA** — *Skrývá se v listí, aby přinesla smrt*

Úroveň 8 | 30 bz | Hody 14 | Obrana 3 | Pohyb B | Morálka 15 | Hmyz

- **Břitvové drápy:** HZ 8, POŠ 5. *Silný zásah: sevře cíl a způsobuje 2 poškození za kolo, dokud se neosvobodí.*

### Božský

**VELKÝ ČERV PÍSKU** — *Pouštní tlama, polyká celé armády*

Úroveň 10 | 75 bz | Hody 18 | Obrana 4 | Pohyb R | Morálka 17 | Hmyz

- **Rozevřená tlama:** HZ 10, POŠ 5. *Jakýkoli zásah: při třech párech se zahrabe a vytvoří jámu tekutého písku — všichni Blízko musí uspět v záchranném hodu, nebo spadnou dovnitř. Smrtící úder: pohltí cíl celého a všechny Blízko (ignorujte Tabulku smrti), pokud neuspějí v záchranném hodu na OBR.*

## Vodní tvorové

### Slabí

**ELEKTRICKÝ ÚHOŘ** — *Šokuje víc než jen zvědavost*

Úroveň 2 | 8 bz | Hody 8 | Obrana 0 | Pohyb B | Morálka 8 | Ryba

- **Elektrický výboj:** HZ 5, POŠ 2. *Jakýkoli zásah: každá hozená dvojka způsobí jedno poškození navíc.*

**MOŘSKÝ HAD** — *Jedno kousnutí a jed se šíří*

Úroveň 1 | 6 bz | Hody 9 | Obrana 0 | Pohyb B | Morálka 7 | Plaz

- **Jedovatý kousanec:** HZ 4, POŠ 2. *Silný zásah: způsobí stav Otrávený.*

### Průměrní

**HEJNO PIRANÍ** — *Neprolijte krev v těchto řekách*

Úroveň 2 | 7 bz | Hody 8 | Obrana 0 | Pohyb R | Morálka 10 | Ryba

- **Kousance:** HZ = aktuální bz, POŠ 3. *Smrtící úder: sežere cíl zaživa (ignorujte Tabulku smrti).*

**SIRÉNA** — *Vražedné melodie*

Úroveň 4 | 10 bz | Hody 8 | Obrana 0 | Pohyb B | Morálka 10 | Humanoid

- **Kousnutí:** HZ 6, POŠ 2.
- **Vábivý zpěv:** HZ 6, POŠ 3. *Smrtící úder: místo zabití stáhne cíl pod hladinu.*

**OBŘÍ KRAB** — *Klepeta tvrdá jako železo*

Úroveň 6 | 22 bz | Hody 13 | Obrana 2 | Pohyb B | Morálka 14 | Korýš

- **Klepeta:** HZ 7, POŠ 4. *Jakýkoli zásah: při full-housu popadne další cíl a způsobí mu k4 poškození.*

### Silní

**VELKÝ BÍLÝ ŽRALOK** — *Vrcholový predátor moří*

Úroveň 7 | 28 bz | Hody 12 | Obrana 1 | Pohyb R | Morálka 14 | Ryba

- **Kousnutí:** HZ 8, POŠ 4.

**LEVIATAN** — *Moře se sklání před jeho hněvem*

Úroveň 9 | 45 bz | Hody 14 | Obrana 2 | Pohyb B | Morálka 16 | Ryba?

- **Kousnutí:** HZ 8, POŠ 5.
- **Drtivé smyčky:** HZ 8, POŠ 4. *Jakýkoli zásah: při třech párech přivolá obrovskou vlnu, která převrátí všechny lodě v dosahu.*

### Božský

**KRAKEN** — *Vysává duši z námořníků*

Úroveň 10 | 60 bz | Hody 16 | Obrana 2 | Pohyb R | Morálka 18 | Hlavonožec

- **Chapadla:** HZ 8, POŠ 3. *Speciální: může provést k4 útoků za kolo. Smrtící úder: sežere cíl zaživa (ignorujte Tabulku smrti).*
- **Inkoustový sprej:** HZ 10, POŠ 4. *Jakýkoli zásah: při třech párech postříká černým inkoustem dva další cíle za k6 poškození.*
